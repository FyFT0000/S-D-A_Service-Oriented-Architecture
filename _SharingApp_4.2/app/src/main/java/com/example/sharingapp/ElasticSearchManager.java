...
public class ElasticSearchManager {
    ...
    /**
    The server at 34.202.206.222 is shut down since 3 years ago (at least).
    You will have to install and make work your own Elasticsearch server.
    */
    private static final String INDEX = "83867311"; // TODO: MUST CHANGE THIS to random number string
